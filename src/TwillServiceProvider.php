    ...
    private function registerErrorHandlers(): void
    {
        ...
        if ($handler instanceof Handler) {
            $handler->renderable(function (HttpExceptionInterface $e) {
                ...
                if (\A17\Twill\Facades\TwillRoutes::isTwillRequest()) {
                    $view = "twill.errors.$statusCode";

                    return response()->view(view()->exists($view) ? $view : "twill::errors.$statusCode", [
                    ...
                    return view()->exists($view) ? response()->view($view, [
                        'errors' => new ViewErrorBag,
                        'exception' => $e,
            ...
            $handler->renderable(function (ValidationException $exception) use ($handler) {
                if (\A17\Twill\Facades\TwillRoutes::isTwillRequest() && request()->expectsJson()) {
